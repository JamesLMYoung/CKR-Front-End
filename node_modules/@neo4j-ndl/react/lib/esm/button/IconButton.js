...
export const IconButton = React.forwardRef(function Button(_a, ref) {
    ...
    , Object.assign({}, restProps, (Component === 'button' ? { type } : {}), { onClick: handleClick, disabled: !interactable, className: classes, ref: ref, children: loading ? (_jsx(LoadingSpinner, { size: "small" })) : (_jsx("div", { className: "ndl-icon", children: children })) })));
});
