...
const TextLink = react_1.default.forwardRef(function TextLink(_a, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)(Component, Object.assign({}, restProps, { className: classes, href: href, ref: ref }, (disabled && { tabIndex: -1 }), (propsTarget && { target: propsTarget }), { children: [(0, jsx_runtime_1.jsx)("div", { children: children }), externalLink && ((0, jsx_runtime_1.jsx)("div", { children: (0, jsx_runtime_1.jsx)(icons_1.ArrowTopRightOnSquareIconSolid, { className: "ndl-external-link-icon" }) }))] })));
});
