...
const AccordionComponent = (0, helpers_1.forwardRef)(function AccordionComponent(_a, ref) {
    ...
    const classes = (0, defaultImports_1.classNames)('ndl-accordion', className);
    const Component = as;
    ...
    return ((0, jsx_runtime_1.jsx)(Component, Object.assign({}, rootProps, { className: classes, ref: accordionRef, onKeyDown: handleKeyDown, children: (0, jsx_runtime_1.jsx)(AccordionContext.Provider, { value: contextValue, children: children }) })));
});
...
const AccordionItem = (_a) => {
    ...
    const classes = (0, defaultImports_1.classNames)('ndl-accordion-item', className, {
        'ndl-accordion-item-disabled': disabled,
    });
    const headerClasses = (0, defaultImports_1.classNames)('ndl-accordion-item-header', {
        'ndl-accordion-item-header-disabled': disabled,
    });
    const iconClasses = (0, defaultImports_1.classNames)('ndl-accordion-item-header-icon-wrapper', {
        'ndl-accordion-item-header-icon-wrapper-right': arrowPosition === 'right',
    });
    const buttonClasses = (0, defaultImports_1.classNames)('ndl-accordion-item-header-button', {
        'ndl-accordion-item-header-button-disabled': disabled,
    });
    const titleClasses = (0, defaultImports_1.classNames)('ndl-accordion-item-header-button-title', {
        'ndl-accordion-item-header-button-title': disabled,
        'ndl-accordion-item-header-button-title-right': arrowPosition === 'right',
    });
    const contentClasses = (0, defaultImports_1.classNames)('ndl-accordion-item-content', {
        'ndl-accordion-item-content-expanded': isExpanded,
        'ndl-accordion-item-content-right': arrowPosition === 'right',
    });
    const headerTitle = (0, jsx_runtime_1.jsx)("span", { className: titleClasses, children: title });
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({}, restProps, { className: classes, id: itemElementId, children: [(0, jsx_runtime_1.jsx)(typography_1.Typography, { variant: "subheading-medium", className: headerClasses, role: "heading", tabIndex: disabled ? -1 : 0, id: headerElementId, "aria-level": "2", children: (0, jsx_runtime_1.jsx)("button", { id: buttonElementId, onClick: handleOnClick, className: buttonClasses, "aria-expanded": isExpanded, "aria-disabled": disabled, "aria-label": title, "aria-controls": panelElementId, tabIndex: -1, children: (0, jsx_runtime_1.jsxs)("span", { className: iconClasses, children: [headerTitle, (0, jsx_runtime_1.jsx)(icons_1.ChevronDownIconOutline, { className: (0, defaultImports_1.classNames)('ndl-accordion-item-header-icon', {
