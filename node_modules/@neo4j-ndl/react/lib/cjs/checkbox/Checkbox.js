...
const Checkbox = react_1.default.forwardRef((_a, ref) => {
    var { 'aria-label': ariaLabel, label } = _a, restProps = __rest(_a, ['aria-label', "label"]);
    if (!ariaLabel && !label) {
    ...
    return ((0, jsx_runtime_1.jsx)(RadioAndCheckboxWrapper_1.default, Object.assign({}, restProps, { label: label, "aria-label": ariaLabel, ref: ref, type: "checkbox", role: "checkbox" })));
});
